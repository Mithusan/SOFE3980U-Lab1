...
public class App 
{
	...
	*/
    public static void main( String[] args )
    {
		...
		System.out.println( "Their summation is "+orCheck.getValue());

		System.out.println("\n***********************************************\nAND\n");
		Binary andCheck= Binary.and(binary1,binary2);
		System.out.println( "Their summation is "+andCheck.getValue());

		System.out.println("\n***********************************************\nMultiply\n");
		Binary multCheck= Binary.multiply(binary1,binary2);
		System.out.println( "Their summation is "+multCheck.getValue());
    }
}
